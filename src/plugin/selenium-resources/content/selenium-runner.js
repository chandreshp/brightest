...
/*
 * Code for running Selenium inside BrighTest-Recorder window.
...
objectExtend(IDETestLoop.prototype, {
        ...
        nextCommand: function() {
            ...
            var modifiedDslCommand = getDSLCommand(command);
            if (modifiedDslCommand) {
                return modifiedDslCommand;
            }
            return new SeleniumCommand(command.command, command.target, command.value);
        },
        
    getDSLCommand: function(command) {
        return null;
    },
        ...
        commandComplete: function(result) {
            ...
            if (testCase.debugContext && testCase.debugContext.currentCommand()) {
                if (result.failed) {
